...
export default function InterviewDashboard() {
  ...
  return (
    <div className="p-6">
      <Navbar />
      <h1 className="text-3xl mt-4 text-center font-bold mb-6">Top Four Interviews</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-[#06121c] h-auto px-4 rounded-lg shadow-lg shadow-emerald-800">
          <h2 className="text-xl text-white font-bold my-4">Interview Performance Overview</h2>
